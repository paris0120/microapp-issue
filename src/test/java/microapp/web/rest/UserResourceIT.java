...
import microapp.config.Constants;
import microapp.domain.Authority;
import microapp.domain.User;
import microapp.repository.AuthorityRepository;
import microapp.repository.EntityManager;
import microapp.repository.UserRepository;
import microapp.security.AuthoritiesConstants;
import microapp.service.dto.AdminUserDTO;
import microapp.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("microapp_user_authority").block();
