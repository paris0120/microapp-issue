...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("microapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("microapp.security.DomainUserDetailsService", "createSpringSecurityUser");
